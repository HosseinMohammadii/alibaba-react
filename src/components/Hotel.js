...
class Hotel extends Component {
    ...
    render() {
        ...
        let general = facilities["general"]
        ...
        let housekeeping = facilities["housekeeping"]
        let shopping = facilities["shopping"]
        let entertainment = facilities["entertainment"]
        let activities = facilities["activities"]
        let misc = facilities["misc"]
        let hotel_services = facilities["hotel_services"]
        let business_meetings = facilities["business_meetings"]
        let transportation = facilities["business_meetings"]
                            ...
                            <ul className="hotel_page_facilities">
                                ...
                                <li className="hotel_page_facility">
                                    ...
                                    <div className="hotel_page_facility_title_and_items">
                                        ...
                                        <ul className="hotel_page_facility_items">
                                            {hotel_services ? hotel_services.map((hotel_service, index) => {
                                                return (
                                                    <li className="hotel_page_facility_item">
                                                        {hotel_service}
                                                    </li>
                                ...
                                <li className="hotel_page_facility">
                                    ...
                                    <div className="hotel_page_facility_title_and_items">
                                        ...
                                        <ul className="hotel_page_facility_items">
                                            {transportation ? transportation.map((trans, index) => {
                                                return (
                                                    <li className="hotel_page_facility_item">
                                                        {trans}
                                                    </li>
                                ...
                                <li className="hotel_page_facility">
                                    ...
                                    <div className="hotel_page_facility_title_and_items">
                                        ...
                                        <ul className="hotel_page_facility_items">
                                            {customer_services ? customer_services.map((customer_service, index) => {
                                                return (
                                                    <li className="hotel_page_facility_item">
                                                        {customer_service}
                                                    </li>
                                ...
                                <li className="hotel_page_facility">
                                    ...
                                    <div className="hotel_page_facility_title_and_items">
                                        <div className="hotel_page_facility_title">
                                            سرگرمی و خدمات خانواده
                                    </div>
                                        <ul className="hotel_page_facility_items">
                                            {entertainment ? entertainment.map((entertain, index) => {
                                                return (
                                                    <li className="hotel_page_facility_item">
                                                        {entertain}
                                                    </li>
                                ...
                                <li className="hotel_page_facility">
                                    ...
                                    <div className="hotel_page_facility_title_and_items">
                                        ...
                                        <ul className="hotel_page_facility_items">
                                            {housekeeping ? housekeeping.map((housekeep, index) => {
                                                return (
                                                    <li className="hotel_page_facility_item">
                                                        {housekeep}
                                                    </li>
                                ...
                                <li className="hotel_page_facility">
                                    ...
                                    <div className="hotel_page_facility_title_and_items">
                                        ...
                                        <ul className="hotel_page_facility_items">
                                            {business_meetings ? business_meetings.map((business, index) => {
                                                return (
                                                    <li className="hotel_page_facility_item">
                                                        {business}
                                                    </li>
                                ...
                                <li className="hotel_page_facility">
                                    ...
                                    <div className="hotel_page_facility_title_and_items">
                                        ...
                                        <ul className="hotel_page_facility_items">
                                            {shopping ? shopping.map((shop, index) => {
                                                return (
                                                    <li className="hotel_page_facility_item">
                                                        {shop}
                                                    </li>
